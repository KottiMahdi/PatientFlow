...
class ProfileDropDownBuilder {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            decoration: _buildContainerDecoration(provider, primaryColor, isValid),
            child: Padding(
          ...
          if ((provider.isEditing && isEditable) && !isValid && errorText != null)
  ...
  static Widget _buildLabelRow(BuildContext context, IconData icon, String title, bool isRequired) {
    return Padding(
